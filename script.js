...
const translations = {
  vi: {
    ...
    exp_1_role: "Sinh viên tự làm project (Năm cuối)",
  ...
  en: {
    ...
    hero_desc: "I like building things from scratch — APIs, databases, auth, deployment. Looking for an internship where I can work on real systems.",
    ...
    exp_1_role: "Final-year Student (Self-directed Projects)",
    exp_1_company: "Personal & Academic Projects",
    exp_1_desc: "Built QuanTra Coffee — an e-commerce site with VNPay/Momo integration and an AI chatbot. Also built TWMS — an academic workload management tool with automated contract generation. Both are school projects but I pushed them as close to production-quality as I could.",
